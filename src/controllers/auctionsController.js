...
exports.setActiveAudio = async (
  ...
  try {
    ...
    /// NO PERMITIR AUDIO DESDE CAMERA_2
    if (
      settings.camera_count === 1 &&
      audio === 'camera_2'
    ) {
